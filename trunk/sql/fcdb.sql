...
insert  into `fc_characteritems`(`character_id`,`item_id`,`count`) values (1,21,1),(1,22,1),(1,25,1),(1,26,1),(1,27,1),(1,28,1),(1,29,1),(1,30,1),(1,31,1),(1,32,1),(1,33,1);
...
insert  into `fc_charactermissions`(`character_id`,`mission_id`,`success_count`,`failure_count`,`complete`) values (1,1,3,0,'1'),(1,2,65,0,'1'),(1,3,20,0,'1'),(1,4,73,0,'1');
